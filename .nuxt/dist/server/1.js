...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/article/index.vue?vue&type=template&id=54dd5e0c&
...
// CONCATENATED MODULE: ./pages/article/index.vue?vue&type=template&id=54dd5e0c&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/article/components/article-meta.vue?vue&type=template&id=1b8b724a&
var article_metavue_type_template_id_1b8b724a_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"article-meta"},[_c('nuxt-link',{attrs:{"to":{
    name: 'profile',
    params: {
    ...
    }}},[_vm._v(_vm._s(_vm.article.author.username))]),_vm._ssrNode(" <span class=\"date\">"+_vm._ssrEscape(_vm._s(_vm._f("date")(_vm.article.createAt,'MMM DD, YYYY')))+"</span>")],2),_vm._ssrNode(" "),(_vm.article.author.username !== _vm.user.username)?[_vm._ssrNode("<button"+(_vm._ssrClass("btn btn-sm {{}}",[_vm.article.author.following ? 'btn-secondary' : 'btn-outline-secondary']))+"><i class=\"ion-plus-round\"></i>"+_vm._ssrEscape("\n       \n      "+_vm._s(_vm.article.author.following ? 'Unfollow' : 'Follow')+"\n      ")+"<span class=\"counter\">"+_vm._ssrEscape(_vm._s(_vm.article.author.username))+"</span></button>\n      \n    <button"+(_vm._ssrClass("btn btn-sm",[_vm.article.favorited ? 'btn-primary' : 'btn-outline-primary']))+"><i class=\"ion-heart\"></i>\n       \n      Favorite Post\n      <span class=\"counter\">"+_vm._ssrEscape(_vm._s(_vm.article.favoritesCount))+"</span></button>")]:[_c('nuxt-link',{staticClass:"btn btn-outline-secondary btn-sm",class:{
      actice: _vm.article.author.following
    },attrs:{"to":{
      name: 'editor',
      params: {
        slug: _vm.article.slug
      }
    }}},[_c('i',{staticClass:"ion-edit"}),_vm._v("\n       \n      Edit Article\n    ")]),_vm._ssrNode("\n    \n      \n    <button"+(_vm._ssrClass("btn btn-outline-danger btn-sm",{
      actice: _vm.article.author.favorited
    }))+"><i class=\"ion-trash-a\"></i> \n       \n      Delete Article\n    </button>")]],2)}
var article_metavue_type_template_id_1b8b724a_staticRenderFns = []


// CONCATENATED MODULE: ./pages/article/components/article-meta.vue?vue&type=template&id=1b8b724a&
...
/* harmony default export */ var article_metavue_type_script_lang_js_ = ({
  ...
  methods: {
    async delArticle() {
      await Object(edit["a" /* deleteArticle */])(this.article);
      this.$router.push('/');
    },
    ...
    async followLike(name, following) {
      ...
      const {
        data
      } = !following ? await Object(api_article["c" /* followUser */])(name) : await Object(api_article["h" /* unFollowUser */])(name);
      console.log(data);
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  article_metavue_type_template_id_1b8b724a_render,
  article_metavue_type_template_id_1b8b724a_staticRenderFns,
  false,
  injectStyles,
  null,
  "68de9048"
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/article/components/article-comments.vue?vue&type=template&id=5dd62f1a&
var article_commentsvue_type_template_id_5dd62f1a_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<form class=\"card comment-form\"><div class=\"card-block\"><textarea placeholder=\"Write a comment...\" rows=\"3\" class=\"form-control\"></textarea></div> <div class=\"card-footer\"><img src=\"http://i.imgur.com/Qr71crq.jpg\" class=\"comment-author-img\"> <button class=\"btn btn-sm btn-primary\">Post Comment</button></div></form> "),_vm._l((_vm.comments),function(comment){return _vm._ssrNode("<div class=\"card\">","</div>",[_vm._ssrNode("<div class=\"card-block\"><p class=\"card-text\">"+_vm._ssrEscape(_vm._s(comment.body))+"</p></div> "),_vm._ssrNode("<div class=\"card-footer\">","</div>",[_c('nuxt-link',{staticClass:"comment-author",attrs:{"to":{
        name: 'profile',
        params: {
...
var article_commentsvue_type_template_id_5dd62f1a_staticRenderFns = []


// CONCATENATED MODULE: ./pages/article/components/article-comments.vue?vue&type=template&id=5dd62f1a&
...
var article_comments_component = Object(componentNormalizer["a" /* default */])(
  ...
  article_commentsvue_type_template_id_5dd62f1a_render,
  article_commentsvue_type_template_id_5dd62f1a_staticRenderFns,
  false,
